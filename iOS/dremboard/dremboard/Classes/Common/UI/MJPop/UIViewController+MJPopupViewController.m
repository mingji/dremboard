...
#define kMJSourceViewTag 21000
#define kMJPopupViewTag 22000
#define kMJOverlayViewTag 23000
...
- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    [self presentPopupView:popupViewController.view animationType:animationType TouchDismiss:YES dismissed:dismissed];
}
...
- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType TouchDismiss:(bool)shouldTouchDismiss
{
    self.mj_popupViewController = popupViewController;
    [self presentPopupView:popupViewController.view animationType:animationType TouchDismiss:shouldTouchDismiss dismissed:nil];
}
...
//    UIView *overlayView = [sourceView viewWithTag:kMJOverlayViewTag];
    UIView *popupView = [self getViewWithTagLast:sourceView BaseTag:kMJPopupViewTag];
    UIView *overlayView = [self getViewWithTagLast:sourceView BaseTag:kMJOverlayViewTag];
...
{
    [self presentPopupView:popupView animationType:animationType TouchDismiss:YES dismissed:nil];
}

- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType TouchDismiss:(bool)shouldTouchDismiss dismissed:(void(^)(void))dismissed
{
    UIView *sourceView = [self topView];
    sourceView.tag = kMJSourceViewTag;
    popupView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleLeftMargin |UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleRightMargin;
//    popupView.tag = kMJPopupViewTag;
    popupView.tag = [self getFreeTag:sourceView BaseTag:kMJPopupViewTag];
...
//    overlayView.tag = kMJOverlayViewTag;
    overlayView.tag = [self getFreeTag:sourceView BaseTag:kMJOverlayViewTag];
...
- (UIView *) getViewWithTagLast:(UIView *)parentView BaseTag:(int)baseTag {
    UIView * retView = nil;
    UIView * tmpView = nil;
    int tmpTag = baseTag;
    
    tmpView = [parentView viewWithTag:tmpTag];
...
- (int) getFreeTag:(UIView *)parentView BaseTag:(int)baseTag {
    UIView * tmpView = nil;
    int tmpTag = baseTag;
