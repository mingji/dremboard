...
@interface DremboardMoveMediaVC ()

@end

@implementation DremboardMoveMediaVC
...
- (IBAction)onClickMove:(id)sender {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(clickMove:)]) {
        [self.delegate clickMove:targetId];
    }
}

- (IBAction)onClickClose:(id)sender {
    if (self.delegate && [self.delegate respondsToSelector:@selector(closeDremboardMoveView)]) {
        [self.delegate closeDremboardMoveView];
    }
}
