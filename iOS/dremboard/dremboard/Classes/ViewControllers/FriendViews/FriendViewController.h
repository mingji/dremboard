...
@interface FriendViewController : UIViewController <HttpTaskDelegate, MBProgressHUDDelegate, UITableViewDataSource, DremerViewCellDelegate, BlockViewDelegate, AcceptViewDelegate>
{
    HttpTask *mHttpTask;
    ...
    NSString * mType; // get dremers type
