//
//  MediaDremboardViewController.m
//  dremboard
//
...
@interface MediaDremboardViewController ()

@end

static int PER_PAGE = 10;

@implementation MediaDremboardViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    // Do any additional setup after loading the view.
    [self.mCollectionDremboardView setDataSource:self];
...
- (void) setupRefreshControl {
    ...
    [self.mCollectionDremboardView addSubview:mRefreshControl];
    self.mCollectionDremboardView.alwaysBounceVertical = YES;
}
...
- (void) resetDremboardsData {
    ...
    [self.mCollectionDremboardView reloadData];
}
