...
public class ActivityFollowers extends SherlockFragmentActivity implements OnClickListener{
    TabHost mTabHost;
    ...
    private void setupTabs()
    {
        ...
        Bundle follower = new Bundle();
        follower.putString("type", "follower");
        follower.putInt("dremer_id", mDremerId);
        
        mTabsAdapter.addTab(mTabHost.newTabSpec("followers").setIndicator("Followers"),
        		FragmentDremers.class, follower);
    }
